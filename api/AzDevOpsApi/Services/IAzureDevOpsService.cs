...
namespace AzDevOpsApi.Services
{
    public interface IAzureDevOpsService
    {
        ...
        Task<IEnumerable<AzureDevOpsBuild>> GetBuildsAsync(string project, string organization, string pat, int pipelineId, int count, string statusFilter = "all", string? branch = null, string? reasonFilter = null);
